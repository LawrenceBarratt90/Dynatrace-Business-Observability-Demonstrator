...
<p class="date">Dynatrace Intelligence &bull; Business Outcome Engine &bull; ${esc(formatDate())}</p>
<h1>${esc(company)}</h1>
...
<div class="footer">
  <p>Prepared by Dynatrace Intelligence &bull; Business Outcome Engine</p>
