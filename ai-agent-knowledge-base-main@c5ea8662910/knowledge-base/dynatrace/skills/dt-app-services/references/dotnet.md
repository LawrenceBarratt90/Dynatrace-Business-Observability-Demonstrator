...
timeseries memory_bytes = avg(dt.runtime.clr.memory.consumption),
          by: {dt.entity.process, dt.entity.process_group, generation = clr.gc.generation},
          from: now() - 2h
| fieldsAdd
...
timeseries thread_count = avg(dt.runtime.clr.threadpool.threads),
          ...
          by: {dt.entity.process, dt.entity.process_group, thread_type = clr.threadpool.thread_type},
          from: now() - 30m
| fieldsAdd
