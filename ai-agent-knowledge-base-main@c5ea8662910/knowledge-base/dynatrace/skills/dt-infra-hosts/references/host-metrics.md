...
| fieldsAdd host_name = entityName(dt.entity.host, type:"dt.entity.host")
...
| lookup [
    ...
    | fieldsAdd cpuCores
  ], sourceField:dt.entity.host, lookupField:id, fields:{cpuCores}
| fieldsAdd
...
```dql
timeseries cpu_usage = avg(dt.host.cpu.usage), by: {dt.entity.host}, interval: 1m
| fieldsAdd host_name = entityName(dt.entity.host, type:"dt.entity.host")
| summarize
    min_cpu = min(cpu_usage),
    max_cpu = max(cpu_usage),
    avg_cpu = avg(cpu_usage),
    by: {dt.entity.host, host_name}
...
| fieldsAdd
    host_name = entityName(dt.entity.host, type:"dt.entity.host"),
...
```dql
timeseries page_faults = avg(dt.host.memory.avail.pfps), by: {dt.entity.host}
| fieldsAdd host_name = entityName(dt.entity.host, type:"dt.entity.host")
...
```dql
timeseries memory_used = avg(dt.host.memory.used), by: {dt.entity.host}, interval: 15m
| fieldsAdd host_name = entityName(dt.entity.host, type:"dt.entity.host")
| summarize
...
}, by: {dt.entity.host, dt.entity.network_interface}
| fieldsAdd host_name = entityName(dt.entity.host, type:"dt.entity.host")
