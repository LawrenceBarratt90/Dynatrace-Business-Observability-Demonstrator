...
| fieldsAdd process_name = entityName(dt.entity.process_group_instance, type:"dt.entity.process_group_instance")
...
}, by: {dt.entity.host, dt.entity.process_group_instance}
| fieldsAdd
    host_name = entityName(dt.entity.host, type:"dt.entity.host"),
    process_name = entityName(dt.entity.process_group_instance, type:"dt.entity.process_group_instance")
...
```dql
timeseries metric = avg(dt.host.<metric>), by: {dt.entity.host}
...
### Best Practices
- Use `entityName()` to get human-readable names
