...
| summarize
    ...
    by: {app_name, long_task.attribution.container_src}
...
| summarize
    task_count = count(),
    avg_duration = avg(duration),
    by: {app_name, long_task.attribution.container_id, long_task.attribution.container_src}
