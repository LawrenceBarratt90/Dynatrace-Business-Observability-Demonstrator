...
# Output: fetch dt.entity.service | fields entity.name | sort entity.name asc
```
...
(the same `dt-app-dashboard` folder that contains this file).
...
bash <dt-app-dashboard-skill-dir>/scripts/validate_dashboard.sh <dashboard-id>
```
